...
$result = mysqli_query($con, "SELECT * FROM dc_personal");
$i = 0;
...
$study = $_POST['branch'];
$other=$_POST['txtbox'];
$sql = "INSERT INTO dc_personal (personal_code,personal_gender,personal_occ,personal_time,personal_gpa,personal_study,personal_other)
