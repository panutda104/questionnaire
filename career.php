            ...
            <div class="form-group row">
              <div class="col-sm-12">
                <select name="branch1" id="branch1" class="css_s2 form-control input-sm" required="" style="border: 2px solid #ced4da;border-radius: 9px;font-family: 'Mitr', sans-serif; width: 100%; height: 40px; font-size: 18px " oninvalid="this.setCustomValidity('โปรดเลือกอาชีพ')"oninput="setCustomValidity('')"  >
                    ...
                    <option value="ผู้เขียนเนื้อหาเว็บ">ผู้เขียนเนื้อหาเว็บ (Web Content Writer)</option>
                    ...
                    <option value="นักพัฒนาเว็บ">นักพัฒนาเว็บ (Web Developer)</option>
                    <option value="โปรแกรมเมอร์พัฒนา">โปรแกรมเมอร์พัฒนา .NET (.NET Programmer)</option>
                    <option value="ผู้ดูแลเว็บ">ผู้ดูแลเว็บ (Web Master)</option>
                    <option value="ผู้ออกแบบ">ผู้ออกแบบ UI/UX (UI/UX Designer)</option>
                    <option value="นักพัฒนามือถือข้ามแพลตฟอร์ม">นักพัฒนามือถือข้ามแพลตฟอร์ม (Cross-platform Mobile Developer)</option>
                    <option value="นักพัฒนามือถือซามารีน">นักพัฒนามือถือซามารีน (Xamarin Mobile Developer)</option>
                    <option value="นักพัฒนามือถือระบบปฎิบัติการ">นักพัฒนามือถือระบบปฎิบัติการ Android (Android Mobile Developer)</option>
                    <option value="นักพัฒนามือถือระบบปฎิบัติการ">นักพัฒนามือถือระบบปฎิบัติการ IOS (IOS Mobile Developer)</option>    
                    <option value="นักพัฒนาแอปพลิเคชันมือถือ">นักพัฒนาแอปพลิเคชันมือถือ (Mobile Application Developer)</option>   
                    <option value="นักพัฒนาซอฟต์แวร์">นักพัฒนาซอฟต์แวร์ (Software Developer)</option>
                    <option value="นักวิเคราะห์ระบบ">นักวิเคราะห์ระบบ (System Analyst)</option>
