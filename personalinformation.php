...
<body>
        <div class="slideshow-container">
            <section id="page1" class="page1">
                ...
                <div class="shade1">
                    <div class="text_shade1">
                        ...
                        <form action="">
                            ...
                            <form action="">
                            <input type="radio" id="iocc" name="more1" value="น้อยกว่า 1 ปี">
                            <label for="น้อยกว่า 1 ปี">น้อยกว่า 1 ปี</label><br>
                            <input type="radio" id="iocc" name="year1" value="1-3 ปี">
                            <label for="1-3 ปี">1-3 ปี</label><br>
                            <input type="radio" id="iocc" name="year4" value="4-6 ปี">
                            <label for="4-6 ปี">4-6 ปี</label><br>
                            <input type="radio" id="iocc" name="year7" value="7-9 ปี">
                            <label for="7-9 ปี">7-9 ปี</label><br>
                            <input type="radio" id="iocc" name="year10" value="10 ปี ขึ้นไป">
                            <label for="10 ปี ขึ้นไป">10 ปี ขึ้นไป</label><br>
                            </form>

                            <p id="text_content1_shade12">ผลการเรียนเฉลี่ย (GPAX): *</p>
                            <form>
                                <input type="text2" id="occ2" name="occ">
                            </form>
                            ...
                            <select>
                                ...
                                <option value="สาขาเทคโนโลยีเทคนิคศึกษา สำหรับครูช่าง">สาขาเทคโนโลยีเทคนิคศึกษา สำหรับครูช่าง</option>
                                ...
                                <option value="สาขาวิทยาการสารสนเทศ">สาขาวิทยาการสารสนเทศ</option>                                <option value="12">สาขาระบบสารสนเทศ</option>
                ...
                <button onclick="location.href='questionnaire.php'" class=" button_shade2 prev" onclick="plusSlides(-1)" >ย้อนกลับ</button>   
                <button onclick="location.href='shade1_list.php'" class=" button_shade1 next" onclick="move() " onclick="plusSlides(1) " > ถัดไป</button>
            </section>
        </div>
