...
<section id="page1" class="page1">
                ...
                <div class="shade3">
                    <div>
                        <i><p id="text_content1_shade3">คำถามเก็บรวบรวมข้อมูลความรู้ของนักศึกษา กำหนดเกณฑ์การให้คะแนนระดับความสามารถเป็น scale 0 ถึง 100</p></i>
                    </div> 
                    <div>
                        ...
                        <div class="range-wrap53">
                            <div class="range-value53" id="rangeV53"></div>
                                <input id="range53" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap54">
                            <div class="range-value54" id="rangeV54"></div>
                                <input id="range54" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap55">
                            <div class="range-value55" id="rangeV55"></div>
                                <input id="range55" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap56">
                            <div class="range-value56" id="rangeV56"></div>
                                <input id="range56" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap57">
                            <div class="range-value57" id="rangeV57"></div>
                                <input id="range57" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap58">
                            <div class="range-value58" id="rangeV58"></div>
                                <input id="range58" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap59">
                            <div class="range-value59" id="rangeV59"></div>
                                <input id="range59" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap60">
                            <div class="range-value60" id="rangeV60"></div>
                                <input id="range60" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap61">
                            <div class="range-value61" id="rangeV61"></div>
                                <input id="range61" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap62">
                            <div class="range-value62" id="rangeV62"></div>
                                <input id="range62" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap63">
                            <div class="range-value63" id="rangeV63"></div>
                                <input id="range63" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap64">
                            <div class="range-value64" id="rangeV64"></div>
                                <input id="range64" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap65">
                            <div class="range-value65" id="rangeV65"></div>
                                <input id="range65" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap66">
                            <div class="range-value66" id="rangeV66"></div>
                                <input id="range66" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap67">
                            <div class="range-value67" id="rangeV67"></div>
                                <input id="range67" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap68">
                            <div class="range-value68" id="rangeV68"></div>
                                <input id="range68" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap69">
                            <div class="range-value69" id="rangeV69"></div>
                                <input id="range69" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap70">
                            <div class="range-value70" id="rangeV70"></div>
                                <input id="range70" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap71">
                            <div class="range-value71" id="rangeV71"></div>
                                <input id="range71" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap72">
                            <div class="range-value72" id="rangeV72"></div>
                                <input id="range72" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap73">
                            <div class="range-value73" id="rangeV73"></div>
                                <input id="range73" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap74">
                            <div class="range-value74" id="rangeV74"></div>
                                <input id="range74" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap75">
                            <div class="range-value75" id="rangeV75"></div>
                                <input id="range75" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap76">
                            <div class="range-value76" id="rangeV76"></div>
                                <input id="range76" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap77">
                            <div class="range-value77" id="rangeV77"></div>
                                <input id="range77" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        <p id="text_content2_shade3">78 . จิตวิทยา (Psychology)       </p>
                        <div class="range-wrap78">
                            <div class="range-value78" id="rangeV78"></div>
                                <input id="range78" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap79">
                            <div class="range-value79" id="rangeV79"></div>
                                <input id="range79" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap80">
                            <div class="range-value80" id="rangeV80"></div>
                                <input id="range80" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap81">
                            <div class="range-value81" id="rangeV81"></div>
                                <input id="range81" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap82">
                            <div class="range-value82" id="rangeV82"></div>
                                <input id="range82" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="range-wrap83">
                            <div class="range-value83" id="rangeV83"></div>
                                <input id="range83" type="range" min="0" max="100" value="50" step="1">
                        </div>
                    </div>
                    <!-- button -->
